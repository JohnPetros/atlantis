...
export class AccomodationBuilder implements Builder<Accommodation> {
  private accomodationName: AccomodationName = AccomodationName.SIMPLE_SINGLE
  ...
  constructor() {
    this.accomodationName = AccomodationName.SIMPLE_SINGLE
    this.singleBeds = 0
    this.coupleBeds = 0
    this.suites = 0
  ...
  setAccomodationName(accomodationName: AccomodationName): this {
